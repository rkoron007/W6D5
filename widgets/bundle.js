...
var _w_root = __webpack_require__(28);

var _w_root2 = _interopRequireDefault(_w_root);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

document.addEventListener("DOMContentLoaded", function () {
  var root = document.getElementById("root");
  _reactDom2.default.render(_react2.default.createElement(_w_root2.default, null), root);
});
...
var array = [{ title: 'Look at me!', content: 'Whazzup?' }, { title: 'Tab2: look at you', content: 'hey you! Come over here.' }, { title: 'tab3', content: 'shhhh. You didnt see me.' }];

var WRoot = function (_React$Component) {
  _inherits(WRoot, _React$Component);

  function WRoot() {
    _classCallCheck(this, WRoot);

    return _possibleConstructorReturn(this, (WRoot.__proto__ || Object.getPrototypeOf(WRoot)).apply(this, arguments));
  }
  ...
  _createClass(WRoot, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_tabs2.default, array)
      );
    }
  }]);
...
var Clock = function (_React$Component) {
  ...
  _createClass(Clock, [{
    ...
    value: function render() {
      ...
      var hr = addZeroBefore(this.state.currentTime.getHours() % 12);
      var min = addZeroBefore(this.state.currentTime.getMinutes());
      var sec = addZeroBefore(this.state.currentTime.getSeconds());
      return _react2.default.createElement(
        'div',
        { className: 'clock' },
...
var Tabs = function (_React$Component) {
  ...
  _createClass(Tabs, [{
    ...
    value: function selectTab(num) {
      ...
      return function () {
        return _this2.setState({ currentTab: num });
      };
    }
  }, {
    key: "render",
